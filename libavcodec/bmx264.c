                       ...
                       const x264_nal_t *nals, int nnal)
{
    ...
    ret = ff_alloc_packet2(ctx, pkt, size, 0);
    if (ret < 0)
        return ret;
...
AVCodec ff_bmx264_encoder = {
    .name             = "bmx264",
    .long_name        = NULL_IF_CONFIG_SMALL("bmx264 H.264 / AVC / MPEG-4 AVC / MPEG-4 part 10"),
    .type             = AVMEDIA_TYPE_VIDEO,
    .id               = AV_CODEC_ID_H264,
    .priv_data_size   = sizeof(BMX264Context),
    .init             = BMX264_init,
    .encode2          = BMX264_frame,
    .close            = BMX264_close,
    .capabilities     = AV_CODEC_CAP_HARDWARE | AV_CODEC_CAP_DELAY,
    .priv_class       = &bmx264_class,
    .defaults         = bmx264_defaults,
