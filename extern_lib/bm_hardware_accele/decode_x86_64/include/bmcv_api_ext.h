...
/*
* The image is operated by median blur
* input_data_global_addr is the device space of the input image.
* padded_input_data_global_addr is the input image pad0 after the device space.
* output is the output image after median filtering.
* width indicates the width of the input image, height indicates the height of the input image.
* format indicates the format of the input image, ksize indicates the median filter kernel size.
*/
