...
#define CVI_VC_DRV_ENCODER_DEV_NAME			"soph_vc_enc"
#define CVI_VC_DRV_DECODER_DEV_NAME			"soph_vc_dec"
...
#define CVI_VC_VDEC_FRAME_ADD_USER			_IO(CVI_VC_DRV_IOCTL_MAGIC, 80)
...
#define CVI_VC_VENC_SET_H265_SAO			_IO(CVI_VC_DRV_IOCTL_MAGIC, 83)
#define CVI_VC_VENC_GET_H265_SAO			_IO(CVI_VC_DRV_IOCTL_MAGIC, 84)
#define CVI_VC_VENC_GET_HEADER				_IO(CVI_VC_DRV_IOCTL_MAGIC, 85)
#define CVI_VC_VENC_GET_EXT_ADDR			_IO(CVI_VC_DRV_IOCTL_MAGIC, 86)

#define CVI_VC_VCODEC_SET_CHN               _IO(CVI_VC_DRV_IOCTL_MAGIC, 100)
#define CVI_VC_VCODEC_GET_CHN               _IO(CVI_VC_DRV_IOCTL_MAGIC, 101)


#define CVI_VC_VENC_SET_MJPEG_PARAM            _IO(CVI_VC_DRV_IOCTL_MAGIC, 102)
#define CVI_VC_VENC_GET_MJPEG_PARAM            _IO(CVI_VC_DRV_IOCTL_MAGIC, 103)
#define CVI_VC_VENC_ENABLE_IDR                 _IO(CVI_VC_DRV_IOCTL_MAGIC, 104)
#define CVI_VC_VENC_SET_H265_PRED_UNIT         _IO(CVI_VC_DRV_IOCTL_MAGIC, 105)
#define CVI_VC_VENC_GET_H265_PRED_UNIT         _IO(CVI_VC_DRV_IOCTL_MAGIC, 106)
#define CVI_VC_VENC_SET_SEARCH_WINDOW          _IO(CVI_VC_DRV_IOCTL_MAGIC, 107)
#define CVI_VC_VENC_GET_SEARCH_WINDOW          _IO(CVI_VC_DRV_IOCTL_MAGIC, 108)
