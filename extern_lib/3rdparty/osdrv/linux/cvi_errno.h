...
#define CVI_ERR_VO_DEV_HAS_BINDED CVI_DEF_ERR(CVI_ID_VO, EN_ERR_LEVEL_ERROR, EN_ERR_VO_DEV_HAS_BINDED)
#define CVI_ERR_VO_DEV_NOT_BINDED CVI_DEF_ERR(CVI_ID_VO, EN_ERR_LEVEL_ERROR, EN_ERR_VO_DEV_NOT_BINDED)
...
#define CVI_ERR_VO_VIDEO_HAS_BINDED CVI_DEF_ERR(CVI_ID_VO, EN_ERR_LEVEL_ERROR, EN_ERR_VO_VIDEO_HAS_BINDED)
#define CVI_ERR_VO_VIDEO_NOT_BINDED CVI_DEF_ERR(CVI_ID_VO, EN_ERR_LEVEL_ERROR, EN_ERR_VO_VIDEO_NOT_BINDED)
...
#define CVI_ERR_DPU_INVALID_DEVID CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_DEVID)
#define CVI_ERR_DPU_INVALID_CHNID CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_CHNID)
#define CVI_ERR_DPU_ILLEGAL_PARAM CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
#define CVI_ERR_DPU_EXIST CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_EXIST)
#define CVI_ERR_DPU_UNEXIST CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_UNEXIST)
#define CVI_ERR_DPU_NULL_PTR CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
#define CVI_ERR_DPU_NOT_CONFIG CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_CONFIG)
#define CVI_ERR_DPU_NOT_SUPPORT CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
#define CVI_ERR_DPU_NOT_PERM CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
#define CVI_ERR_DPU_NOMEM CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_NOMEM)
#define CVI_ERR_DPU_NOBUF CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_NOBUF)
#define CVI_ERR_DPU_BUF_EMPTY CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_EMPTY)
#define CVI_ERR_DPU_BUF_FULL CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_FULL)
#define CVI_ERR_DPU_NOTREADY CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
#define CVI_ERR_DPU_ERR_BADADDR CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_BADADDR )
#define CVI_ERR_DPU_BUSY CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_BUSY)
#define CVI_ERR_DPU_SYS_TIMEOUT CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_SYS_TIMEOUT)
#define CVI_ERR_DPU_OPEN_FILE CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_OPEN_FILE)
#define CVI_ERR_DPU_READ_FILE CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_READ_FILE)
#define CVI_ERR_DPU_WRITE_FILE CVI_DEF_ERR(CVI_ID_DPU, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_WRITE_FILE)
...
#define CVI_ERR_STITCH_NULL_PTR CVI_DEF_ERR(CVI_ID_STITCH, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
#define CVI_ERR_STITCH_NOTREADY CVI_DEF_ERR(CVI_ID_STITCH, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
#define CVI_ERR_STITCH_INVALID_SRCID CVI_DEF_ERR(CVI_ID_STITCH, EN_ERR_LEVEL_ERROR, EN_ERR_INVALID_DEVID)
#define CVI_ERR_STITCH_EXIST CVI_DEF_ERR(CVI_ID_STITCH, EN_ERR_LEVEL_ERROR, EN_ERR_EXIST)
#define CVI_ERR_STITCH_UNEXIST CVI_DEF_ERR(CVI_ID_STITCH, EN_ERR_LEVEL_ERROR, EN_ERR_UNEXIST)
#define CVI_ERR_STITCH_NOT_SUPPORT CVI_DEF_ERR(CVI_ID_STITCH, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
#define CVI_ERR_STITCH_NOT_PERM CVI_DEF_ERR(CVI_ID_STITCH, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
#define CVI_ERR_STITCH_NOMEM CVI_DEF_ERR(CVI_ID_STITCH, EN_ERR_LEVEL_ERROR, EN_ERR_NOMEM)
#define CVI_ERR_STITCH_NOBUF CVI_DEF_ERR(CVI_ID_STITCH, EN_ERR_LEVEL_ERROR, EN_ERR_NOBUF)
#define CVI_ERR_STITCH_ILLEGAL_PARAM CVI_DEF_ERR(CVI_ID_STITCH, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
#define CVI_ERR_STITCH_BUSY CVI_DEF_ERR(CVI_ID_STITCH, EN_ERR_LEVEL_ERROR, EN_ERR_BUSY)
#define CVI_ERR_STITCH_BUF_EMPTY CVI_DEF_ERR(CVI_ID_STITCH, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_EMPTY)

/* DWA define error code */
#define CVI_ERR_DWA_NOBUF CVI_DEF_ERR(CVI_ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_NOBUF)
#define CVI_ERR_DWA_NOMEM CVI_DEF_ERR(CVI_ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_NOMEM)
#define CVI_ERR_DWA_BUF_EMPTY CVI_DEF_ERR(CVI_ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_EMPTY)
#define CVI_ERR_DWA_NULL_PTR CVI_DEF_ERR(CVI_ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_NULL_PTR)
#define CVI_ERR_DWA_ILLEGAL_PARAM CVI_DEF_ERR(CVI_ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_ILLEGAL_PARAM)
#define CVI_ERR_DWA_BUF_FULL CVI_DEF_ERR(CVI_ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_BUF_FULL)
#define CVI_ERR_DWA_SYS_NOTREADY CVI_DEF_ERR(CVI_ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_SYS_NOTREADY)
#define CVI_ERR_DWA_NOT_SUPPORT CVI_DEF_ERR(CVI_ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SUPPORT)
#define CVI_ERR_DWA_NOT_PERMITTED CVI_DEF_ERR(CVI_ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_PERM)
#define CVI_ERR_DWA_BUSY CVI_DEF_ERR(CVI_ID_DWA, EN_ERR_LEVEL_ERROR, EN_ERR_BUSY)
