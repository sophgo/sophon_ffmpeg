...
typedef enum _CVI_HDMI_VIDEO_FORMAT {
    CVI_HDMI_VIDEO_FORMAT_CEA861_640x480p60      = 1,
    CVI_HDMI_VIDEO_FORMAT_CEA861_720x480p60      = 2,
...
typedef enum _CVI_HDMI_EVENT_TYPE {
    CVI_HDMI_EVENT_HOTPLUG = 1,
    CVI_HDMI_EVENT_NO_PLUG = 2,
    CVI_HDMI_EVENT_EDID_FAIL = 3,
    CVI_HDMI_EVENT_BUTT,
} CVI_HDMI_EVENT_TYPE;
...
typedef enum _CVI_HDMI_SAMPLE_RATE {
    ...
    CVI_HDMI_SAMPLE_RATE_176K = 176400,
...
typedef struct _CVI_HDMI_ATTR {
    ...
    CVI_BOOL audio_en;
    CVI_BOOL hdcp14_en;
    CVI_HDMI_FORCE_ACTION hdmi_force_output;
...
typedef struct _CVI_HDMI_VIDEO_INFO {
    CVI_HDMI_VIDEO_FORMAT mcode;
    CVI_HDMI_TIMING_INFO timing_info;
    CVI_U32 fresh_rate;
} CVI_HDMI_VIDEO_INFO;
...
typedef struct _CVI_HDMI_SINK_CAPABILITY {
    ...
    CVI_HDMI_VIDEO_INFO support_video_format[CVI_HDMI_VIDEO_FORMAT_BUTT];
