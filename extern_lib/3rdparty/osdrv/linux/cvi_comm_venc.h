...
typedef struct _VENC_PACK_S {
	...
	CVI_S32 releasFrameIdx;
    CVI_U64 u64CustomMapPhyAddr; /* R; the physics address of custom map addr */
    CVI_U32 u32AvgCtuQp; /* R; The average value of CTU QPs */
} VENC_PACK_S;
...
typedef struct _VENC_CUSTOM_GOP_PIC_PARAM {
    CVI_S32 s32PicType;      /**< A picture type of Nth picture in the custom GOP */
    CVI_S32 s32PocOffset;    /**< A POC of Nth picture in the custom GOP */
    CVI_S32 s32PicQp;        /**< A quantization parameter of Nth picture in the custom GOP */
    CVI_S32 s32UseMultiRefP; /**< A flag to use multi reference picture for P picture. It is valid only if PIC_TYPE is P */
    CVI_S32 s32RefPocL0;     /**< A POC of reference L0 of Nth picture in the custom GOP */
    CVI_S32 s32RefPocL1;     /**< A POC of reference L1 of Nth picture in the custom GOP */
    CVI_S32 s32TemporalId;   /**< A temporal ID of Nth picture in the custom GOP */
...
typedef struct _VENC_CUSTOM_GOP_PARAM {
    CVI_S32 s32CustomGopSize;                       /**< The size of custom GOP (1 ~ 8) */
...
typedef struct _VENC_GOP_EX_ATTR_S {
    CVI_U32 u32GopPreset;		        /**< gop preset for video encoder(h264/h265) */
...
typedef struct _VENC_CUSTOM_MAP_S {
    CVI_S32 roiAvgQp;              /**< It sets an average QP of ROI map. */
    CVI_S32 customRoiMapEnable;    /**< It enables ROI map. */
    CVI_S32 customLambdaMapEnable; /**< It enables custom lambda map. */
    CVI_S32 customModeMapEnable;   /**< It enables to force CTU to be encoded with intra or to be skipped.  */
    CVI_S32 customCoefDropEnable;  /**< It enables to force all coefficients to be zero after TQ or not for each CTU (to be dropped).*/
/**
@verbatim
